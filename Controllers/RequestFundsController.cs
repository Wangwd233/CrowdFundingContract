...
namespace CrowdFundingContract.Controllers
{
    public class RequestFundsController : Controller
    {
        ...
        public RequestFundsController(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        private List<RequestFunds> RequestFundsList()
        {
            ...
            list = _context.RequestFunds.ToList();
            return list;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FundTitle,FundDescription,AmountNeeded,Created")] RequestFunds requestFunds)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FundTitle,FundDescription,AmountNeeded,Created")] RequestFunds requestFunds)
        {
