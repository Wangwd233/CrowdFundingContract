...
using CrowdFundingContract.Data;
...
namespace CrowdFundingContract.Controllers
{
    public class FundersController : Controller
    {
        ...
        public FundersController(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        {
            ViewData["RequestFundsId"] = new SelectList(_context.RequestFunds, "Id", "FundDescription");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Amount,Key,Receiver,RequestFundsId")] Funders funders)
        {
            ...
            ViewData["RequestFundsId"] = new SelectList(_context.RequestFunds, "Id", "FundDescription", funders.RequestFundsId);
            return View(funders);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Amount,Key,Receiver,RequestFundsId")] Funders funders)
        {
            if (id != funders.Id)
            {
                return NotFound();
